...
NodeTastic.prototype = {
  ...
  attachGlobalServiceInstance: function(serviceInstance) {
    return this.attachServiceInstance(this.globalClassInstance, serviceInstance);
  },
  ...
  attachServiceInstance: function(classInstance, serviceInstance) {
    ...
    classInstance[serviceInstance.constructor.AttachedPropertyName] = serviceInstance;
  },
